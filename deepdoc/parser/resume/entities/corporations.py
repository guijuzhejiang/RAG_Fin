...
CORP_TKS = json.load(open(os.path.join(current_file_path, "res/ja_corp.tks.freq.json"), "r"))
GOOD_CORP = json.load(open(os.path.join(current_file_path, "res/ja_good_corp.json"), "r"))
CORP_TAG = json.load(open(os.path.join(current_file_path, "res/ja_corp_tag.json"), "r"))
