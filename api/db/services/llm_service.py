...
class TenantLLMService(CommonService):
    ...
    def model_instance(cls, tenant_id, llm_type,
        ...
        if not model_config and llm_type != LLMType.SPEECH2TEXT:
        ...
        if llm_type == LLMType.SPEECH2TEXT:
            ...
            #     base_url=model_config["api_base"]
            # )
            return Seq2txtModel['FasterWhisper'](
                key='xxxxxxxxxxxxxxx',
                model_name='faster-whisper-large-V3',
                lang=lang,
                # base_url='http://whisper-asr-webservice-gpu:9000/asr?encode=true&task=transcribe&vad_filter=true&word_timestamps=true&output=txt&language=ja',
                base_url='http://127.0.0.1:9010/asr?encode=true&task=transcribe&vad_filter=true&word_timestamps=true&output=txt&language=ja',
            )
...
class LLMBundle(object):
    ...
    def similarity(self, query: str, texts: list):
        ...
        #     database_logger.error("Can't update token usage for {}/RERANK".format(self.tenant_id))
