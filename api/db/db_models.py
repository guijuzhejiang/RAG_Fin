...
class User(DataBaseModel, UserMixin):
    ...
    language = CharField(
        max_length=32,
        null=True,
        help_text="English|Chinese|Japanese",
        default="Japanese",
        index=True)
...
class Knowledgebase(DataBaseModel):
    ...
    language = CharField(
        max_length=32,
        null=True,
        # default="Japanese" if "ja_JP" in os.getenv("LANG", "") else "English",
        default="Japanese",
        help_text="English|Chinese|Japanese",
        index=True)
...
class Dialog(DataBaseModel):
    ...
    prompt_config = JSONField(null=False, default={"system": "", "prologue": "Hi! I'm your assistant, what can I do for you?",
                                                   "parameters": [], "empty_response": "Answer not found in the knowledge base."})

    similarity_threshold = FloatField(default=0.2)
    # search_depth = FloatField(default=0.06)
        ...
        try:
            migrate(
                migrator.add_column('tenant', 'rerank_id',
                                    CharField(max_length=128, null=False, default="bge-reranker-v2-m3",
                                              help_text="default rerank model ID"))
