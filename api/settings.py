...
# LLM_BASE_URL = LLM.get("base_url", "http://ollama:11434" if LLM_FACTORY == "Ollama" else "")
LLM_BASE_URL = LLM.get("base_url", "http://localhost:11434" if LLM_FACTORY == "Ollama" else "")

if not LIGHTEN:
    default_llm = {
        "Ollama": {
            "chat_model": "qwen3-14B-think-Q4_K_M",
            "embedding_model": "nomic-embed-text:v1.5",
            "image2text_model": "blaifa/InternVL3_5:8b",
            "asr_model": "",
        },
        "Tongyi-Qianwen": {
    ...
    # RERANK_MDL = "hotchpotch/japanese-reranker-cross-encoder-large-v1"
    RERANK_MDL = "bge-reranker-v2-m3"
