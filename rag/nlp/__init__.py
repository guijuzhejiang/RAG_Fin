...
all_codecs = [
    'utf-8', 'shift_jis', 'gb2312', 'gbk', 'utf_16', 'ascii', 'big5', 'big5hkscs',
...
def tokenize_chunks(chunks, doc, eng, pdf_parser=None):
    ...
    for ck in chunks:
        ...
        if pdf_parser:
            try:
                # d["image"], poss = pdf_parser.crop(ck, ZM=1.33, need_position=True)
...
def keyword_extraction(chat_mdl, content):
    prompt = """
あなたは質問分析者です。
1. この質問における最も重要なキーワードやフレーズを教えてください。
Answer format: (ユーザーの質問の言語で)
 - keyword: 
"""
